...
public interface AdvertisementRepository extends JpaRepository<Advertisement, Integer> {
	...
	@Query(value =	"SELECT * FROM advertisement WHERE category_id = :categoryId AND enabled = 1", nativeQuery = true)
	public List<Advertisement> getAllByCategoryIdEnabled(@Param("categoryId") Integer categoryId);
